...
public class MethodTest {
	...
	@Test
	public void testInvokeToString() throws SecurityException, NoSuchMethodException, IllegalArgumentException,
			IllegalAccessException, InvocationTargetException {
		User user = new User(7, "wohlmuther", "SuperSecurePassword");

		Method m = user.getClass().getDeclaredMethod("toString");
		String s = (String) m.invoke(user);

		Assert.assertEquals("7,wohlmuther,SuperSecurePassword", s);
	}
}
