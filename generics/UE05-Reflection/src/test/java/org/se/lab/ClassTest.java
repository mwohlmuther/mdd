...
public class ClassTest {
	 ...
	 * Class is to invoke Object.getClass()
	 */
	@Test
	public void testGetClass() {
		User u = new User(7, "wohlmuther", "superSecurePassword");
	 ...
	 * obtain a Class by appending ".class" to the name of the type. This is also
	 ...
	 * the corresponding Class using the static method Class.forName(). This cannot
